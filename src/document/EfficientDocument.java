...
public class EfficientDocument extends Document {
	...
	private void processText()
	{
		...
		// This is to check whether the whole text does NOT end with sentence-ending punctuation, ie. [!?.], 
		// so the end has to count as a sentence. Empty texts has to be avoided.
